...
**Key Topics:** Publishers, Subjects, AnyPublisher · map, flatMap, combineLatest, switchToLatest · AnyCancellable, retain cycles, [weak self] · tryMap, catch, replaceError, Never
